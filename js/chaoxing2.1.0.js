...
var setting = {
    ...
    ,login: 1 // 自动登录，支持监测掉线并自动重连，需要配置详细参数，默认关闭

    // 仅开启video时，修改此处才会生效
    ,line: '公网1' // 视频播放的默认资源线路，此功能适用于系统默认线路无资源，默认'公网1'
    ,http: '极速' // 视频播放的默认清晰度，可以设置'标清'等，无参数则使用系统默认清晰度，默认''
    ...
    ,school: '江汉大学' // 学校名称，要求完整有效可查询，例如'清华大学'，默认''
    ,username: '182206101311' // 学号/工号/借书证号(邮箱/手机号/账号)，例如'2018010101'，默认''
    ,password: '420502' // 密码，例如'123456'，默认''
},
_self = unsafeWindow,
top = _self.top,
$ = _self.$ || top.$,
